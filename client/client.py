...
class FlowerClient(fl.client.Client):
    def __init__(self, cid, server_address, server_port, dataset_path):
        ...
        self.parameters_handler = ParametersHandler(raw_train_data=self.raw_train_data, preprocessed_train_data=self.preprocessed_train_data,
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        print("Usage: python client.py <data_path> <client_id>")
        sys.exit(1)
    data_path = sys.argv[1]
    print(data_path)
    #----------------------------------------
    cid = "client_" + str(sys.argv[2])
    print(cid)
